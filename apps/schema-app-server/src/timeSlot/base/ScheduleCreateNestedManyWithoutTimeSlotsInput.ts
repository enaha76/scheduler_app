...
@InputType()
class ScheduleCreateNestedManyWithoutTimeSlotsInput {
...
export { ScheduleCreateNestedManyWithoutTimeSlotsInput as ScheduleCreateNestedManyWithoutTimeSlotsInput };
