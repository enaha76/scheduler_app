...
@InputType()
class ScheduleCreateNestedManyWithoutAcademicWeeksInput {
...
export { ScheduleCreateNestedManyWithoutAcademicWeeksInput as ScheduleCreateNestedManyWithoutAcademicWeeksInput };
