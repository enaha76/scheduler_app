...
@InputType()
class ScheduleCreateNestedManyWithoutProfessorsInput {
...
export { ScheduleCreateNestedManyWithoutProfessorsInput as ScheduleCreateNestedManyWithoutProfessorsInput };
